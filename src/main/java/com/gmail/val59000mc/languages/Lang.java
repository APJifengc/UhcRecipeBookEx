...
public class Lang{
	...
	public static String PLAYERS_KILLED;
	...
	public static String ITEMS_SPEED_HEAD;
	public static String ITEMS_SPEED_HEAD_ACTION;
	public static String ITEMS_CORN;
	...
	public static String ITEMS_GOLDEN_HEAD_APPLE_LORE;
	public static String ITEMS_GOLDEN_HEAD_APPLE_ACTION;
	...
	public static String ITEMS_MASTER_COMPASS;
	public static String ITEMS_ARTEMIS_BOW;
	public static String ITEMS_MODULAR_BOW_LIGHTNING;
	public static String ITEMS_MODULAR_BOW_POISON;
	public static String ITEMS_MODULAR_BOW_PUNCH;
	public static String ITEMS_MODULAR_BOW_TO_LIGHTNING_1;
	public static String ITEMS_MODULAR_BOW_TO_LIGHTNING_2;
	public static String ITEMS_MODULAR_BOW_TO_POISON_1;
	public static String ITEMS_MODULAR_BOW_TO_POISON_2;
	public static String ITEMS_MODULAR_BOW_TO_PUNCH_1;
	public static String ITEMS_MODULAR_BOW_TO_PUNCH_2;
	public static String ITEMS_MODULAR_BOW_LORE_1;
	public static String ITEMS_MODULAR_BOW_LORE_2;
	public static String ITEMS_MODULAR_BOW_LORE_3;
	public static String ITEMS_MODULAR_BOW_LORE_4;
	public static String ITEMS_BOW_NOT_CRITICAL;
	public static String ITEMS_FLASK;
	public static String ITEMS_FLASK_HIT;
	public static String ITEMS_FUSION_ARMOR;
	public static String ITEMS_FUSION_HELMET;
	public static String ITEMS_FUSION_CHESTPLATE;
	public static String ITEMS_FUSION_LEGGINGS;
	public static String ITEMS_FUSION_BOOTS;
	public static String ITEMS_FUSION_INFO_1;
	public static String ITEMS_FUSION_INFO_2;
	public static String ITEMS_DEUS_EX_MACHINA;
	public static String ITEMS_EXCALIBUR;
	public static String ITEMS_PERUN;
	public static String ITEMS_DEATH;
	public static String ITEMS_DEATH_MESSAGE;
	public static String ITEMS_ANDURIL;
	public static String ITEMS_MINER;
	public static String ITEMS_BLOODLUST;
	public static String ITEMS_APPRENTICE_SWORD;
	public static String ITEMS_APPRENTICE_BOW;
	public static String ITEMS_CANT_ENCHANT;
	...
	public static String ITEMS_STRENGTH_2_POTION_BANNED;
	public static String ITEMS_SHARPNESS_AXE_BANNED;
	...
	private void loadLangConfig() {
		...
		PLAYERS_KILLED = getString(lang, "players.killed", "%killed% was slain by %killer%");
		...
		ITEMS_SPEED_HEAD = getString(lang, "items.speed-head", "&cRight click to regen your team for 5 seconds");
		ITEMS_SPEED_HEAD_ACTION = getString(lang, "items.speed-head-action", "&aYou get a 5 seconds regen effect for eating a player head");
		ITEMS_CORN = getString(lang, "items.corn", "&cRight click to regen your team for 5 seconds");
		...
		ITEMS_GOLDEN_HEAD_APPLE_LORE = getString(lang, "items.golden-head.apple-lore", "&eEat this to heal 4 hearts and get 2 absorption hearts.");
		ITEMS_GOLDEN_HEAD_APPLE_ACTION = getString(lang, "items.golden-head.apple-action", "&eEat this to heal 4 hearts and get 2 absorption hearts.");
		...
		ITEMS_MASTER_COMPASS = getString(lang, "items.master-compass", "&cRight click to regen your team for 5 seconds");
		ITEMS_ARTEMIS_BOW = getString(lang, "items.artemis-bow", "&cRight click to regen your team for 5 seconds");
		ITEMS_MODULAR_BOW_LIGHTNING = getString(lang, "items.modular-bow-lightning", "1");
		ITEMS_MODULAR_BOW_POISON = getString(lang, "items.modular-bow-poison", "1");
		ITEMS_MODULAR_BOW_PUNCH = getString(lang, "items.modular-bow-punch", "1");
		ITEMS_MODULAR_BOW_TO_LIGHTNING_1 = getString(lang, "items.modular-bow-to-lightning-1", "1");
		ITEMS_MODULAR_BOW_TO_LIGHTNING_2 = getString(lang, "items.modular-bow-to-lightning-2", "1");
		ITEMS_MODULAR_BOW_TO_PUNCH_1 = getString(lang, "items.modular-bow-to-punch-1", "1");
		ITEMS_MODULAR_BOW_TO_PUNCH_2 = getString(lang, "items.modular-bow-to-punch-2", "1");
		ITEMS_MODULAR_BOW_TO_POISON_1 = getString(lang, "items.modular-bow-to-poison-1", "1");
		ITEMS_MODULAR_BOW_TO_POISON_2 = getString(lang, "items.modular-bow-to-poison-2", "1");
		ITEMS_MODULAR_BOW_LORE_1 = getString(lang, "items.modular-bow-lore-1", "1");
		ITEMS_MODULAR_BOW_LORE_2 = getString(lang, "items.modular-bow-lore-2", "1");
		ITEMS_MODULAR_BOW_LORE_3 = getString(lang, "items.modular-bow-lore-3", "1");
		ITEMS_MODULAR_BOW_LORE_4 = getString(lang, "items.modular-bow-lore-4", "1");
		ITEMS_BOW_NOT_CRITICAL = getString(lang, "items.bow-not-critical", "11");
		ITEMS_FLASK = getString(lang, "items.flask", "11");
		ITEMS_FLASK_HIT = getString(lang, "items.flask-hit", "11");
		ITEMS_FUSION_ARMOR = getString(lang, "items.fusion-armor", "&cRight click to regen your team for 5 seconds");
		ITEMS_FUSION_HELMET = getString(lang, "items.fusion-helmet", "&cRight click to regen your team for 5 seconds");
		ITEMS_FUSION_CHESTPLATE = getString(lang, "items.fusion-chestplate", "&cRight click to regen your team for 5 seconds");
		ITEMS_FUSION_LEGGINGS = getString(lang, "items.fusion-leggings", "&cRight click to regen your team for 5 seconds");
		ITEMS_FUSION_BOOTS = getString(lang, "items.fusion-boots", "&cRight click to regen your team for 5 seconds");
		ITEMS_FUSION_INFO_1 = getString(lang, "items.fusion-info-1", "&cRight click to regen your team for 5 seconds");
		ITEMS_FUSION_INFO_2 = getString(lang, "items.fusion-info-2", "&cRight click to regen your team for 5 seconds");
		ITEMS_DEUS_EX_MACHINA = getString(lang, "items.deus-ex-machina", "&cRight click to regen your team for 5 seconds");
		ITEMS_EXCALIBUR = getString(lang, "items.excalibur", "1");
		ITEMS_PERUN = getString(lang, "items.perun", "1");
		ITEMS_DEATH = getString(lang, "items.death", "1");
		ITEMS_DEATH_MESSAGE = getString(lang, "items.death-message", "1");
		ITEMS_ANDURIL = getString(lang, "items.anduril", "1");
		ITEMS_MINER = getString(lang, "items.miner", "1");
		ITEMS_BLOODLUST = getString(lang, "items.bloodlust", "1");
		ITEMS_APPRENTICE_SWORD = getString(lang, "items.apprentice-sword", "1");
		ITEMS_APPRENTICE_BOW = getString(lang, "items.apprentice-bow", "1");
		ITEMS_CANT_ENCHANT = getString(lang, "items.cant-enchant", "&eThis item can't be enchanted");
		...
		ITEMS_STRENGTH_2_POTION_BANNED = getString(lang, "items.strength-2-potion-banned", "&cSorry, level 2 potions are banned.");
		ITEMS_SHARPNESS_AXE_BANNED = getString(lang, "items.sharpness-axe-banned", "&cSorry, sharpness axes are banned.");
