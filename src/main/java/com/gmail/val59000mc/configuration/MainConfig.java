...
public class MainConfig extends YamlFile {
	...
	public static final BasicOption<Boolean> BAN_SHARPNESS_AXE= new BasicOption<>("customize-game-behavior.ban-sharpness-axes",false);
	...
	// Modded things
	public static final ListOption<String> DEATHMATCH_COMMANDS = new ListOption<>("deathmatch.commands", ListOption.Type.STRING_LIST);
	public static final ListOption<String> STARTING_GAME_COMMANDS = new ListOption<>("startinggame.commands", ListOption.Type.STRING_LIST);
	public static final BasicOption<Integer> TIME_TO_EXECUTE_COMMAND = new BasicOption<>("startinggame.delay",5);
