...
public enum UniversalMaterial{
    ...
    public static boolean isAxe(Material tool) {
        return tool == Material.DIAMOND_AXE ||
                ...
                tool == Material.NETHERITE_AXE;
    }

    public static boolean isDiamondArmor(Material tool) {
        return tool == Material.DIAMOND_HELMET ||
                tool == Material.DIAMOND_CHESTPLATE ||
                tool == Material.DIAMOND_LEGGINGS ||
                tool == Material.DIAMOND_BOOTS ;
    }
